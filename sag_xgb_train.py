...
# 21, 0.0, "1.0", "when a constructor is not provid by the programm of the class", "If no constructor is provided, the compiler provides one by default. If a constructor is defined for a class, the compiler does not create a default constructor."
...
# 30, 1.0, "0.0", "binari search tree are similar to binari tree but have been implement to organ data in a specif way for later search", "A binary tree that has the property that for any node the left child is smaller than the parent which in turn is smaller than the right child."
# 35, 1.0, "0.0", "the inord travers of a binari tree visit the node of a binari tree in order accord to their data valu", "Traverse the left subtree, then the root, then the right subtree."
# 36, 1.0, "0.0", "in the veri begin of the program befor the main start", "Variables can be declared anywhere in a program. They can be declared inside a functionlocal variablesor outside the functionsglobal variables"
...
# 52, 1.0, "0.0", "it depend what type of class is be defin typic you would have a constructor call for each object", "Unlimited number."
# 67, 1.0, "0.0", "it creat a set of candid function then a set of viabl function", "Based on the function signature. When an overloaded function is called, the compiler will find the function whose signature is closest to the given function call."
...
# 94, 1.0, "0.0", "by be pass to the function by a lead term", "First, they are converted into postfix form, followed by an evaluation of the postfix expression."
...
# 123, 1.0, "0.0", "by use an array of charact you are limit to the size of the array of charact by declar by type the end of the string is acknowledg by white space", "The strings declared using an array of characters have a null element added at the end of the array."
...
# 165, 1.0, "0.0", "header file have reusabl sourc code in a file that a program can use", "To store a class interface, including data members and member function prototypes."
# 167, 1.0, "0.0", "they are basic the same howev a string end with a null charact denot the end of the stringand the size a char array ha potenti to be ani size so it must be declar or limit", "The strings declared using an array of characters have a null element added at the end of the array."
...
# 175, 1.0, "0.0", "the main role of header file is it is use to share inform among variou file", "To store a class interface, including data members and member function prototypes."
# 187, 1.0, "0.0", "static long unsign", "Private and public."
...
# 194, 0.0, "1.0", "you do not have to iter through the entir list to access element", "The elements in an array can be accessed directlyas opposed to linked lists, which require iterative traversal."
# 196, 1.0, "0.0", "you would have to travers the stack pop each element to search it", "Pop all the elements and store them on another stack until the element is found, then push back all the elements on the original stack."
...
# 212, 1.0, "0.0", "all of the dimens must be specifi", "All the dimensions, except the first one."
# 213, 1.0, "0.0", "either travers the entir list and pop the given part or creat a pointer system that automat point to it", "Pop all the elements and store them on another stack until the element is found, then push back all the elements on the original stack."
# 215, 1.0, "0.0", "to hide the definit and detail of a class also to help readabl of the main c plu plu file", "To store a class interface, including data members and member function prototypes."
...
# 224, 1.0, "0.0", "linear logarithm exponenti linear linear", "loglog n; 2 to the power oflog n; n to the power of 2; n to the power of 3; n!"
# 231, 0.0, "1.0", "modular reusabl code allow faster deploy of solut and a more gener view of a solut", "Abstraction and reusability."
...
# 243, 1.0, "0.0", "a static array can be can be edit throughout the program while a non-stat array can onli be edit within a given function", "The static arrays are intialized only once when the function is called."
# 261, 1.0, "0.0", "the advantag is that oop allow us to build class of object three principl that make up oop are encapsulation-object combin data and oper inheritance-class can inherit properti from other class polymorphism-object can determin appropri oper at execut time", "Abstraction and reusability."
...
# 273, 1.0, "0.0", "give call function the abil to access and modifi the caller s argument data directli", "It avoids making copies of large data structures when calling functions."
...
# 281, 1.0, "0.0", "the compil can ignor the inlin qualifi and typic doe so for all but the smallest function", "It makes a copy of the function code in every place where a function call is made."
# 298, 1.0, "0.0", "2 to the power oflog n n to the power of 3 n to the power of 2 loglog n n", "loglog n; 2 to the power oflog n; n to the power of 2; n to the power of 3; n!"
# 306, 1.0, "0.0", "postord", "Traverse the left subtree, then the root, then the right subtree."
# 312, 0.0, "1.0", "array are good for random access and good for sequenti access which are both in constant time where link list are linear for random access array are faster in thi case", "The elements in an array can be accessed directlyas opposed to linked lists, which require iterative traversal."
# 313, 0.0, "1.0", "a link list is a data structur contain one or more data element with a pointer to the next node", "A collection of elements that can be allocated dynamically."
# 316, 1.0, "0.0", "charact array will termin at ani whitespac includ space string termin when they encount the new line charact", "The char [] will automatically add a null 0 character at the end of the string."
...
# 326, 1.0, "0.0", "you can travers the list both forward and backward", "All the deletion and insertion operations can be performed in constant time, including those operations performed before a given location in the list or at the end of the list."
...
# 332, 1.0, "0.0", "give function abil to access and modifi the caller s argument data directli", "It avoids making copies of large data structures when calling functions."
...
# 339, 1.0, "0.0", "function can directli modifi argument that are pass by refer", "It avoids making copies of large data structures when calling functions."
...
# 346, 1.0, "0.0", "you would need to perform a search through the list of elementsi dont realli understand what thi question is ask it not veri clear", "Pop all the elements and store them on another stack until the element is found, then push back all the elements on the original stack."
...
# 370, 1.0, "0.0", "object orient program allow programm to use an object with class that can be chang and manipul while not affect the entir object at onc the class all hold attrubut that affect the object", "Abstraction and reusability."
...
# 386, 0.0, "1.0", "convert infix express to postfix express and evalu the postfix express", "First, they are converted into postfix form, followed by an evaluation of the postfix expression."
...
# 394, 1.0, "0.0", "none just pass the array name", "All the dimensions, except the first one."
# 398, 1.0, "0.0", "instruct the compil on how to interfac with librari and user-written compon", "To store a class interface, including data members and member function prototypes."
# 401, 1.0, "0.0", "remov the element then shift the element one space back", "Use a circular array. Keep the rear of the queue toward the end of the array, and the front toward the beginning, and allow the rear pointer to wrap around."
# 402, 1.0, "0.0", "or if you want to initi a variabl to a certain valu equal", "By using constructors."
# 403, 1.0, "0.0", "string with type string are just that string they are not part of an array list at all where as one declar by an array is actual an array of charact abl to be point and detect", "The strings declared using an array of characters have a null element added at the end of the array."
# 404, 1.0, "0.0", "class definit are place here", "To store a class interface, including data members and member function prototypes."
...
# 419, 1.0, "0.0", "an array is pass by refer therefor if an array of charact is chang the memori is chang not just the variabl", "The strings declared using an array of characters have a null element added at the end of the array."
...
# 424, 1.0, "0.0", "the size of the string", "The size in bytes of its operand."
# 426, 1.0, "0.0", "the type string is a class and is safer while the other is just an array of charact", "The strings declared using an array of characters have a null element added at the end of the array."
...
# 446, 1.0, "0.0", "it includ the specif inform about the function such as input and output variabl type and how mani of each", "The name of the function and the types of the parameters."
# 448, 1.0, "0.0", "pointer to the child and delet it ha 2 children set the node to the child and delet it the node to th middl will then take it place", "Find the node, then replace it with the leftmost node from its right subtreeor the rightmost node from its left subtree."
# 455, 1.0, "0.0", "from lowest to longest loglog n 2 to the power oflog n n n to the power of 2 n to the power of 3", "loglog n; 2 to the power oflog n; n to the power of 2; n to the power of 3; n!"
...
# 463, 1.0, "0.0", "2 to the power of n where n is the of level the binari tree ha", "The height of the tree."
...
# 477, 1.0, "0.0", "string that are use in an char array are much easier to manipul than as a string object becaus each charact is store separ rather than as a whole", "The strings declared using an array of characters have a null element added at the end of the array."
# 479, 1.0, "0.0", "binari search tree are a fundament data structur use to construct more abstract data structur such as set multiset and associ array", "A binary tree that has the property that for any node the left child is smaller than the parent which in turn is smaller than the right child."
# 483, 0.0, "1.0", "ad a new item and remov the item", "push and pop"
...
# 510, 1.0, "0.0", "variabl are set to a given valu or 0 if none is given", "By using constructors."
# 516, 1.0, "0.0", "the compil can ignor the inlin qualifi and typic doe so for all but the smallest function", "It makes a copy of the function code in every place where a function call is made."
...
# 529, 1.0, "0.0", "it contain reusabl sourc code for use by other class", "To store a class interface, including data members and member function prototypes."
...
# 553, 1.0, "0.0", "an array of string read the string liter mean anyth within quot a char array read a string as each individu charact", "The char [] will automatically add a null 0 character at the end of the string."
...
# 557, 0.0, "1.0", "the compil will provid one when class doe not explictli includ a consructor", "If no constructor is provided, the compiler provides one by default. If a constructor is defined for a class, the compiler does not create a default constructor."
...
# 565, 0.0, "1.0", "class variabl class function prototyp", "Function members and data members."
# 572, 1.0, "0.0", "the primari disadvantag of doubli link list are that1each node requir an extra pointer requir more space and2th insert or delet of a node take a bit longermor pointer oper", "All the deletion and insertion operations can be performed in constant time, including those operations performed before a given location in the list or at the end of the list."
...
# 581, 1.0, "0.0", "just one per class", "Unlimited number."
# 582, 1.0, "0.0", "a static array ha a predetermin size and that size cannot be alter", "The static arrays are intialized only once when the function is called."
# 583, 1.0, "0.0", "a group of data in a parent to child structur", "A collection of nodes, which has a special node called root, and the rest of the nodes are partitioned into one or more disjoint sets, each set being a tree."
...
# 597, 1.0, "0.0", "a constructor initi an object or object of a class a function of a class perform a task such as display a line of text or do some kind of mathemat oper", "A constructor is called whenever an object is created, whereas a function needs to be called explicitely. Constructors do not have return type, but functions have to indicate a return type."
# 598, 0.0, "1.0", "the last valu in the tree a valu with no children attatch", "A node that has no children."
# 599, 1.0, "0.0", "ad up the number of oper perform base on the worst case possibl", "Implement the algorithm and measure the physical running time."
...
# 647, 1.0, "0.0", "n minu 1", "Nthe length of the arrayoperations achieved for a sorted array."
# 653, 1.0, "0.0", "you cannot delet a node becaus that can caus a node to have more than 2 children", "Find the node, then replace it with the leftmost node from its right subtreeor the rightmost node from its left subtree."
# 654, 1.0, "0.0", "when no paramet are set is when a default constructor is use", "If no constructor is provided, the compiler provides one by default. If a constructor is defined for a class, the compiler does not create a default constructor."
...
# 672, 1.0, "0.0", "the list-bas implement is prefer sinc the big o1i veri effici", "Link-based, because they are dynamicno size constraints"
# 673, 0.0, "1.0", "list-bas it can grow and shrink dynam unlik the fix size array", "Link-based, because they are dynamicno size constraints"
# 675, 1.0, "0.0", "pointer may be pass to function by valu by refer with refer argument or by refer with pointer argument", "There are four ways: nonconstant pointer to constant data, nonconstant pointer to nonconstant data, constant pointer to constant data, constant pointer to nonconstant data."
...
# 685, 1.0, "0.0", "it treat them as the same function", "It makes a copy of the function code in every place where a function call is made."
...
# 698, 1.0, "0.0", "pass-by-valu or pass-by-refer", "There are four ways: nonconstant pointer to constant data, nonconstant pointer to nonconstant data, constant pointer to constant data, constant pointer to nonconstant data."
...
# 703, 1.0, "0.0", "as a pointer node", "By reference."
...
# 716, 1.0, "0.0", "2 to the power oflog nn to the power of 2 to the power of 3 loglong nn", "loglog n; 2 to the power oflog n; n to the power of 2; n to the power of 3; n!"
# 717, 1.0, "0.0", "in the main function usual at the top of code they can be declar almost anywher but must be declar befor the code can use or act upon them", "Variables can be declared anywhere in a program. They can be declared inside a functionlocal variablesor outside the functionsglobal variables"
...
# 724, 1.0, "0.0", "could travers through the list or array to find the element", "Pop all the elements and store them on another stack until the element is found, then push back all the elements on the original stack."
# 728, 1.0, "0.0", "you have to keep up with where you are and you have to consid the predecessor and successor connect when insert or delet", "Extra space required to store the back pointers."
...
# Correct Predictions
# id, prediction, correct, answer, correct_answer
# 0, 0.0, "0.0", "by column", "By rows."
# 1, 1.0, "1.0", "unlik in a string declar use type string in a string declar use an array of charact the programm must provid the null termin charact and must ensur the array is larg enough to hold the string and null termin charact", "The strings declared using an array of characters have a null element added at the end of the array."
...
# 29, 1.0, "1.0", "a doubly-link list allow you to delet a node without travers the list to establish a trail pointer", "All the deletion and insertion operations can be performed in constant time, including those operations performed before a given location in the list or at the end of the list."
# 31, 1.0, "1.0", "the sequenc of number ha zero or one element", "When the size of the array to be sorted is 1or 2"
# 32, 1.0, "1.0", "at the minimum lognor log2 at the maximum n search where n is the number of node", "The height of the treeor log of the number of elements in the tree."
...
# 88, 1.0, "1.0", "a string char add a null valu to the end of the string", "The char [] will automatically add a null 0 character at the end of the string."
...
# 109, 1.0, "1.0", "creat a node with the input data continu to add to the list when dequeu get the first element data and set the next element in the list as the new first element", "Keep the rear of the queue pointing to the tail of the linked list, so the enqueue operation is done at the end of the list, and keep the front of the queue pointing to the head of the linked list, so the dequeue operation is done at the beginning of the list."
# 110, 1.0, "1.0", "1 less than the total number of dimens", "All the dimensions, except the first one."
...
# 129, 1.0, "1.0", "when you travers a tree of ani size you will visit each node three time it on the order of 3n or onrun time", "A walk around the tree, starting with the root, where each node is seen three times: from the left, from below, from the right."
...
# 140, 1.0, "1.0", "n oper where n is the number of item", "Nthe length of the arrayoperations achieved for a sorted array."
...
# 153, 1.0, "1.0", "a static array retain ani modifi valu after a function call automat array reset to their initi valu when the function end", "The static arrays are intialized only once when the function is called."
...
# 155, 1.0, "1.0", "the role of a header file list all the function a class can do while hide the inner work of it function", "To store a class interface, including data members and member function prototypes."
...
# 174, 0.0, "0.0", "to lay out the basic and give you a start point in the actual problem solv", "To simulate the behaviour of portions of the desired software product."
...
# 183, 0.0, "0.0", "you store the stack in the array but you have to keep in mind the first element", "Keep the top of the stack toward the end of the array, so the push and pop operations will add or remove elements from the right side of the array."
...
# 200, 1.0, "1.0", "array item are access directli with equal access time", "The elements in an array can be accessed directlyas opposed to linked lists, which require iterative traversal."
...
# 206, 1.0, "1.0", "re-us and eas of mainten", "Abstraction and reusability."
...
# 219, 1.0, "1.0", "to pop element then push them back", "Pop all the elements and store them on another stack until the element is found, then push back all the elements on the original stack."
...
# 226, 1.0, "1.0", "all string repres by charact array end with the null charact you declar an object of type string just like ani other type for exampl string s", "The strings declared using an array of characters have a null element added at the end of the array."
...
# 241, 0.0, "0.0", "to address major issu in the creation of the program there is no way to account for all possibl bug in the program but it is possibl to prove the program is tangibl", "To simulate the behaviour of portions of the desired software product."
...
# 244, 1.0, "1.0", "a hierarchi of node that are sort in a particular order each node ha a ancestorexcept for the rootand childrenexcept for the leav", "A collection of nodes, which has a special node called root, and the rest of the nodes are partitioned into one or more disjoint sets, each set being a tree."
...
# 257, 1.0, "1.0", "the in order is to go from left root right", "Traverse the left subtree, then the root, then the right subtree."
...
# 259, 1.0, "1.0", "the advantag is that each node point to both it predecessor and it successor there are no special case for insert and delet", "All the deletion and insertion operations can be performed in constant time, including those operations performed before a given location in the list or at the end of the list."
...
# 262, 1.0, "1.0", "you run a program with differ data size like 10 to the power of x as you increas x and measur the complet speed for the program you can find pattern and attempt the measur the run time it is veri import to keep the same softwar and hardwar howev which make experiment test inferior to theoret in the eye of most", "Implement the algorithm and measure the physical running time."
# 264, 1.0, "1.0", "a binari search tree is a tree that also ha the condit that each node may have at maximum 2 children and where the input data is compar to the data in the tree start with the root if the valu is smaller than the root it travers left if it is larger it travers right until it becom a leaf", "A binary tree that has the property that for any node the left child is smaller than the parent which in turn is smaller than the right child."
# 265, 0.0, "0.0", "it is more effici and it chang the variabl not onlin insid the function but outsid so that the new valu can be use elsewher", "It avoids making copies of large data structures when calling functions."
...
# 272, 1.0, "1.0", "loglogn2 to the power oflog nn to the power of 2 n to the power of 3 n", "loglog n; 2 to the power oflog n; n to the power of 2; n to the power of 3; n!"
...
# 275, 1.0, "1.0", "from least to greatest loglog n 2 to the power oflog n n to the power of 2 n to the power of 3 n", "loglog n; 2 to the power oflog n; n to the power of 2; n to the power of 3; n!"
...
# 283, 1.0, "1.0", "the star return the valu", "An aliassynonymfor the name of the object that its operand points to in memory. It is the dereferencing operator."
...
# 300, 0.0, "0.0", "to get earli feedback from user in earli stage of develop to show user a first idea of what the program will do or look like to make sure the program will meet requir befor intens program begin", "To simulate the behaviour of portions of the desired software product."
...
# 318, 1.0, "1.0", "store a set of element in a last in first out order", "A data structure that can store elements, which has the property that the last item added will be the first to be removedor last-in-first-out"
...
# 344, 0.0, "0.0", "global variabl can b access by ani class wit an object in the variabl class", "File scope."
...
# 349, 1.0, "1.0", "a constructor set up the default valu of variabl when an object is instanti wherea a function allow interact with that object", "A constructor is called whenever an object is created, whereas a function needs to be called explicitely. Constructors do not have return type, but functions have to indicate a return type."
...
# 358, 1.0, "1.0", "2 to the power oflog nloglog nn to the power of 2 n to the power of 3 n", "loglog n; 2 to the power oflog n; n to the power of 2; n to the power of 3; n!"
...
# 362, 1.0, "1.0", "creat a link list add an element to the top of the stack when push and delet an element when pop", "Keep the top of the stack pointing to the head of the linked list, so the push and pop operations will add or remove elements at the beginning of the list."
...
# 380, 0.0, "0.0", "by argument and refer", "There are four ways: nonconstant pointer to constant data, nonconstant pointer to nonconstant data, constant pointer to constant data, constant pointer to nonconstant data."
...
# 407, 1.0, "1.0", "string is a class in the standard librari and ha method that modifi it wherea the char array is on abl to be modifi by the user", "The strings declared using an array of characters have a null element added at the end of the array."
...
# 415, 1.0, "1.0", "to find a node in a binari search tree take at most the same number of step as there are level of the tree", "The height of the tree."
...
# 422, 1.0, "1.0", "by use the multipli bypoint plu element-index", "By initializing a pointer to point to the first element of the array, and then incrementing this pointer with the index of the array element."
# 425, 1.0, "1.0", "list becaus it size is not defin", "Link-based, because they are dynamicno size constraints"
# 428, 1.0, "1.0", "string declar use the type string can vari in length string declar use an array of charact can not extend past the array length", "The strings declared using an array of characters have a null element added at the end of the array."
...
# 431, 1.0, "1.0", "no base case no chang in valu", "If the recursion step is defined incorrectly, or if the base case is not included."
...
# 439, 0.0, "0.0", "usual it is by row then follow by the column but it is up to the programm to determin how valu are store in bi-dimension array", "By rows."
...
# 458, 1.0, "1.0", "depend on the type of stack on a true stack you will haft to pop all of the element of the stack until you find the element you want and then after that you will need to push all the element that where remov back in to the stack in the order that they where remov with a java style stack where there is a peek function it will return the element you want instead of requir you to perform all the excess action that are requir from a true stack", "Pop all the elements and store them on another stack until the element is found, then push back all the elements on the original stack."
...
# 464, 1.0, "1.0", "stack are a type of contain adaptor specif design to oper in a lifo contextlast-in first-out where element are insert and extract onli from the end of the contain", "A data structure that can store elements, which has the property that the last item added will be the first to be removedor last-in-first-out"
...
# 467, 1.0, "1.0", "a static array will be call onli onc onc it ha been declar the complier will ignor the static line if it come to it again", "The static arrays are intialized only once when the function is called."
...
# 475, 1.0, "1.0", "in a doubli link list you can delet a node without have to travers the list", "All the deletion and insertion operations can be performed in constant time, including those operations performed before a given location in the list or at the end of the list."
# 478, 1.0, "1.0", "pop push", "push and pop"
# 480, 1.0, "1.0", "to provid inform about the content of a librari it includ the definit of class declar of function data type and constant", "To store a class interface, including data members and member function prototypes."
...
# 492, 1.0, "1.0", "with int x 10 int star of xptr xptr equal x address address of x 1 is the same as xptr plu 1", "By initializing a pointer to point to the first element of the array, and then incrementing this pointer with the index of the array element."
...
# 501, 1.0, "1.0", "a list-bas implement is prefer becaus the list is more flexibl than a array", "Link-based, because they are dynamicno size constraints"
...
# 509, 1.0, "1.0", "when non are provid", "If no constructor is provided, the compiler provides one by default. If a constructor is defined for a class, the compiler does not create a default constructor."
...
# 512, 1.0, "1.0", "a list or array of onli 1 element", "When the size of the array to be sorted is 1or 2"
...
# 519, 1.0, "1.0", "the size of the list be sent is is less than or equal to 1", "When the size of the array to be sorted is 1or 2"
...
# 540, 0.0, "0.0", "it provid a limit proof of concept to verifi with the client befor actual program the whole applic", "To simulate the behaviour of portions of the desired software product."
...
# 559, 1.0, "1.0", "you recurs visit everi node on the list you visit the node from the left the bottom and from the right", "A walk around the tree, starting with the root, where each node is seen three times: from the left, from below, from the right."
...
# 571, 1.0, "1.0", "on the list is alreadi sort", "Nthe length of the arrayoperations achieved for a sorted array."
...
# 579, 0.0, "0.0", "specifi an array s size with a constant variabl and set array element with calcul", "In the array declaration, or by using an initializer list."
...
# 600, 1.0, "1.0", "do not have to make copi of stuff", "It avoids making copies of large data structures when calling functions."
...
# 612, 1.0, "1.0", "log n comparison", "The height of the treeor log of the number of elements in the tree."
...
# 620, 1.0, "1.0", "compil select proper function to execut base on number type and order of argument in the function call", "Based on the function signature. When an overloaded function is called, the compiler will find the function whose signature is closest to the given function call."
...
# 623, 0.0, "0.0", "you can go up and down an array but you can onli go one direct while travers a link list", "The elements in an array can be accessed directlyas opposed to linked lists, which require iterative traversal."
...
# 633, 1.0, "1.0", "compil select proper function to execut base on number type and order of argument in the function call", "Based on the function signature. When an overloaded function is called, the compiler will find the function whose signature is closest to the given function call."
# 634, 1.0, "1.0", "a basic link list ha an end with a null valu where a circular link list ha a pointer from the end to the begin", "The last element in a circular linked list points to the head of the list."
...
# 641, 1.0, "1.0", "quickest at top slowest at bottom loglog nn to the power of 2 n to the power of 3 2 to the power oflog nn", "loglog n; 2 to the power oflog n; n to the power of 2; n to the power of 3; n!"
# 642, 1.0, "1.0", "a finit set of node that start with the root and termin with leav", "A collection of nodes, which has a special node called root, and the rest of the nodes are partitioned into one or more disjoint sets, each set being a tree."
# 643, 0.0, "0.0", "variabl can be a integ or a string in a program", "A location in memory that can store a value."
...
# 650, 1.0, "1.0", "they can be access by ani part of the program it can be referenc by ani function that follow the declar or definit in the sourc file", "File scope."
...
# 655, 1.0, "1.0", "array-bas prevent the push oper from ad an item to the stack if the stack s size limit which is the size of the array ha been reach list-bas much simpler to write and doe not have a fix size", "Link-based, because they are dynamicno size constraints"
...
# 674, 1.0, "1.0", "boolean isfullqqueu equal rear equal equal max queue size-1", "Use a circular array. Keep the rear of the queue toward the end of the array, and the front toward the beginning, and allow the rear pointer to wrap around."
...
# 682, 1.0, "1.0", "n minu 1 the best case is when the array is alreadi sort", "Nthe length of the arrayoperations achieved for a sorted array."
...
# 695, 1.0, "1.0", "it depend if it s a global then they have to be declar out side the sourc code to be use in everi scope howev a local variabl is one declar in a local function etc which obvious doesn t need to be declar outsid the variabl see how it is use for the function or block it be call for", "Variables can be declared anywhere in a program. They can be declared inside a functionlocal variablesor outside the functionsglobal variables"
...
# 719, 1.0, "1.0", "one or more node in a hierarchi start with the root and branch off like a tree to subtre", "A collection of nodes, which has a special node called root, and the rest of the nodes are partitioned into one or more disjoint sets, each set being a tree."
